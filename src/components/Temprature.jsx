  ...
  return (
    <>
      <div className="flex justify-center">
        <input
          type="text"
          className="bg-slate-600 border border-slate-500 text-slate-200 placeholder-slate-400 text-md w-30 p-2  focus:outline-none focus:border-slate-400"
      ...
      <div className="flex justify-center items-center text-slate-400 mt-3 text-[12px]">
